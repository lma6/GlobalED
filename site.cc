...
//        }
//
//            int lat=220,lon=240,mon=6;
//            for (mon=0;mon<288;mon+=1)
//            {
//
//                tmp=data->global_tmp[mon][lat][lon];
//                hum=data->global_hum[mon][lat][lon];
...
//
//                Farquhar_couple(0,tmp,hum,swd,CA*1e6,0.8,100.0,shade,Vcmax25,farquhar_results2);
//                printf("Comp vc %f %d %f %f %f __ %.4f %.4f == %.4f %.4f == %.4f %.4f\n",Vcmax25,mon,tmp,hum,swd,farquhar_results2[1]*1e6,farquhar_results3[1]*1e6,farquhar_results2[2]*1e6,farquhar_results3[2]*1e6,farquhar_results2[3]*1e6,farquhar_results3[3]*1e6);
//            }
//
//    exit(0);
